...
class DoctorList extends StatefulWidget {
  final String speciality;
  const DoctorList({Key key, this.speciality}) : super(key: key);
  @override
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: DoctorsTile(speciality: widget.speciality,),
                      );
                    }),
              ),
            ],
...
class DoctorsTile extends StatelessWidget {
  ...
  const DoctorsTile({Key key, this.speciality}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => DoctorsInfo(speciality: speciality,)));
      },
      child: Container(
        decoration: BoxDecoration(
